    ...
    return (
        <>
            <div className="flex gap-2">
                <input type="text" value={photoLink} onChange={ev => setPhotoLink(ev.target.value)} placeholder={"Add using a link ....jpg"}></input>
            ...
            <div className="mt-2 grid gap-2 grid-cols-3 md:grid-col-4 lg:grid-cols-6">
                ...
                <label className="h-32 flex items-center gap-1 justify-center border rounded-2xl p-2 text-2xl text-gray-600">
